            ...
            <el-row>
                <el-col :span=24>
                    <el-table :data="tableData" stripe :header-cell-style="{background:'#D8E3FA'}"
                        ...
                        <!-- <el-table-column prop="payDate" label="日期" min-width align="center"></el-table-column> -->
                        <el-table-column prop="mallName" label="商户名称" min-width align="center"></el-table-column>
                        <el-table-column prop="tradeCount" label="充值笔数" min-width align="center">
                        </el-table-column>
                        <el-table-column prop="payPriceTotal" label="充值金额(元)" min-width align="center">
                        </el-table-column>
                        <el-table-column prop="aliPayTotal" label="支付宝(元)" min-width align="center">
                        </el-table-column>
                        <el-table-column prop="wxPayTotal" label="微信(元)" min-width align="center">
                        </el-table-column>
                    </el-table>
                </el-col>
            </el-row>
...
<script>
    ...
    import { getBusinessIncome, getRechargeStatistics } from "../../api/business"
    ...
    export default {
        ...
        methods: {
            ...
            queryMsg() {
                ...
                getRechargeStatistics(this.query.mallId[0], this.query.startDate, this.query.endDate, this.pageSize, this.pageNum).then(resp => {
                    ...
                    this.tableData.forEach(v => {
                        ...
                        v.bikeChargeTotal = v.bikeChargeTotal / 100;
                        v.shjChargeTotal = v.shjChargeTotal / 100;
                        v.syjChargeTotal = v.syjChargeTotal / 100;
                    })
