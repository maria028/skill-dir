...
<script>
  import {getElectricDetail} from "../../api/electric";
  import {getMallByUser} from "../../api/mall";
  export default {
        name: "realTimeMeterReading",
        data() {
            return {
        ...
        methods: {
            ...
            getMallData(){
                ...
                getElectricDetail(this.formInline.building,this.formInline.mallId,this.formInline.unit,this.formInline.endDate,this.formInline.startDate,this.formInline.room).then(res =>{
