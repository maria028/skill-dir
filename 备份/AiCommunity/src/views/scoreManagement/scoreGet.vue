            ...
            <el-row>
                <el-col :span=24>
                    <el-table :data="tableData" stripe :header-cell-style="{background:'#D8E3FA'}"
                        ...
                        <el-table-column prop="relateType" label="积分获得类型" min-width align="center"></el-table-column>
                        <el-table-column prop="value" label="获得积分" min-width align="center"></el-table-column>
                        <el-table-column prop="createTime" label="时间" min-width align="center"></el-table-column>
                        <el-table-column prop="reason" label="说明" min-width align="center"></el-table-column>
                    </el-table>
                </el-col>
            </el-row>
            <el-row>
            ...
            queryMsg() {
                ...
                getScoreLogList(this.query.mallId[0], this.query.fullRoom, this.query.startDate, this.query.endDate, 1, this.pageSize, this.pageNum).then(resp => {
                    ...
                    this.tableData.forEach(v => {
                        v.relateType = v.relateType == 1 ? "个人" : "家庭";
                        switch (v.type) {
                            case "1":
                                v.type = "在售货机下订单";
                                break;
