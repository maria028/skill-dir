<template>
  <div class="main-bg">
    <div class="header">
      <div style="font-size:3vh;text-align: center;">王马社区·养老用水监控</div>
    ...
    <div style="text-align: center;margin-top: 1vh">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item >
          <el-select v-model="formInline.unit" placeholder="请选择小区">
            <el-option
    ...
    <div class="bg1">
      <div class="bg2">
        <div class="water1" v-for="item in houseData">
          <div class="wBg">
            <div class="m_water">{{item.waterUsage}}</div>
            <div class="m_lj">用水量(L)</div>
          </div>
...
<script>
    ...
    import {getWaterVisualData} from "../../api/waterRes";
        ...
        computed: {
            ...
            cumulantChange(value){
                ...
                if( value === '1'){
                    ...
                    this.formInline.startDate = yesterday;
                    this.formInline.endDate = yesterday;
                    this.titleContent='日用水量(L)';
                    this.intervalData = 3;
                }else{
                    this.valueFormat = 'yyyy-MM';
                    this.formInline.startDate = this.getLastMonth();
                    this.timeType = 'month';
                    this.titleContent='月用水量(L)';
                    this.intervalData = 0;
                }
            },
            ...
            getMallData(){
                ...
                let _this = this;
                if(type === '1'){
                    getByUint(null, this.formInline.mallId,null).then(res =>{
                ...
                getWaterVisualData(this.formInline.building,
                    ...
                    this.houseData = data.waterHouseData;
                    ...
                    this.houseData.forEach(v=>{
                        ...
                        let eleUsageList = v.waterUsageList;
                        let seriesObj = {};
...
<style scoped>
  ...
  .warn_bg{
    background: url("/img/monitoring/warn_bg.png");
    text-align: center;
    background-repeat: no-repeat;
    background-size: 100% 100%;
    -moz-background-size: 100% 100%;
