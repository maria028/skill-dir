            ...
            <el-row>
                <el-col :span=6 class="col">
                    <el-form-item label="数据源">
                        <el-select v-model="query.datasourceId" clearable placeholder="数据源">
                ...
                <el-col :span=6 class="col">
                    <el-form-item label="模块名">
                        <el-input v-model="query.codeName" clearable placeholder="模块名"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span=6 class="col">
                    <el-form-item label="服务名">
                        <el-input v-model="query.serviceName" clearable placeholder="服务名"></el-input>
                    </el-form-item>
                </el-col>
...
<script>
    import {add, build, copy, getCode, getList, remove, update, select} from "@/api/tool/code";
                    ...
                    column: [
                        {
                            ...
                            span: 24,
                            type: "select",
                            dicUrl: baseUrl + "/develop/datasource/select",
                            props: {
                                label: "name",
                                value: "id"
                            },
                        ...
                        },
                        {
                            ...
                            prop: "baseMode",
                            type: 'radio',
                            dicUrl: baseUrl + "/system/dict/dictionary?code=yes_no",
                            props: {
                                label: "dictValue",
                                value: "dictKey"
                            },
            ...
            selectData() {
                select().then(resp => {
                    resp.data.data.forEach(v => {
                        this.dataOptions.push({value: v.id,label: v.name})
                    })
                })
            },
            searchReset() {
